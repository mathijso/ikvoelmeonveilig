    ...
    <body class="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <div class="bg-yellow-500 text-yellow-900 px-4 py-2 text-center text-sm font-medium">
            <div class="max-w-7xl mx-auto flex items-center justify-center space-x-2">
                ...
                <span>⚠️ Ontwikkelingsversie - Dit systeem is nog in ontwikkeling en biedt nog geen garantie voor functionaliteit. Bel bij echte noodsituaties altijd 112.</span>
            </div>
        </div>
